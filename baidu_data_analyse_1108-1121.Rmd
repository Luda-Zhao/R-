...
```{r}
baidu=read.csv("new_word_report_20211108-20211121_32726191_457485.csv")
```
...
title(main=list("推广单元各模块展示比例",cex=2),sub="时间:2021.11.08-2021.11.21", ylab="推广单元",xlab="数量")
text(y=seq(from=1,length.out=37,by=1.19),x=-2000,label=df_sort$levels.baidu_keywords.关键词.,family="STKaiti",cex=0.5)
...
text(labels= paste(round(10000*df_sort$ans/sum(df_sort$ans))/100,"%",sep=""),cex=0.7,
      y=seq(from=1,length.out=37,by=1.19),
      x=df_sort$ans+1000)
...
title(main=list("推广单元各模块点击比例",cex=2),sub="时间:2021.11.08-2021.11.21", ylab="推广单元",xlab="数量")
text(y=seq(from=1,length.out=37,by=1.19),x=-15,label=df_sort$levels.baidu_keywords.关键词.,family="STKaiti",cex=0.5)
legend("topright",legend=levels(baidu_keywords$关键词),cex = 0.5,col=rev(col),ncol=2,pch = 15)
text(labels= paste(round(10000*df_sort$ans/sum(df_sort$ans))/100,"%",sep=""),cex=0.7,
      y=seq(from=1,length.out=37,by=1.19),
      x=df_sort$ans+6)
...
col<-c(brewer.pal(9, "YlOrRd")[1:9],brewer.pal(9, "Blues")[1:9])
par(family="STKaiti")
barplot(df_sort$ans,family="STKaiti",horiz=TRUE,xlim=c(-100,300),col = col)
title(main=list("推广单元各模块消费比例",cex=2),sub="时间:2021.11.08-2021.11.21", ylab="推广单元",xlab="数量")
text(y=seq(from=1,length.out=37,by=1.19),x=-30,label=df_sort$levels.baidu_keywords.关键词.,family="STKaiti",cex=0.5)
legend("topright",legend=levels(baidu_keywords$关键词),cex = 0.5,col=rev(col),ncol=2,pch = 15)
text(labels= paste(round(10000*df_sort$ans/sum(df_sort$ans))/100,"%",sep=""),cex=0.7,
      y=seq(from=1,length.out=37,by=1.19),
      x=df_sort$ans+10)
...
title(main=list("推广单元各模块展示比例",cex=2),sub="时间:2021.11.08-2021.11.21", ylab="日期",xlab="数量")
