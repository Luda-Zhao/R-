...
```{r}
baidu=read.csv("new_word_report_20211206-20211212_32726191_732424.csv")
```
...
par(family="STKaiti")
barplot(df_sort$ans,family="STKaiti",horiz=TRUE,xlim=c(-2000,7000),col = col)
title(main=list("推广单元各模块展示比例",cex=2),sub="时间:2021.12.06-2021.12.12", ylab="推广单元",xlab="数量")
text(y=seq(from=1,length.out=33,by=1.19),x=-500,label=df_sort$levels.baidu_keywords.关键词.,family="STKaiti",cex=0.5)
...
col<-c(brewer.pal(9, "YlOrRd")[1:9],brewer.pal(9, "Blues")[1:9])
par(family="STKaiti")
barplot(df_sort$ans,family="STKaiti",horiz=TRUE,xlim=c(-100,100),col = col)
title(main=list("推广单元各模块点击比例",cex=2),sub="时间:2021.12.06-2021.12.12", ylab="推广单元",xlab="数量")
text(y=seq(from=1,length.out=33,by=1.19),x=-30,label=df_sort$levels.baidu_keywords.关键词.,family="STKaiti",cex=0.5)
legend("topright",legend=levels(baidu_keywords$关键词),cex = 0.5,col=rev(col),ncol=2,pch = 15)
text(labels= paste(round(10000*df_sort$ans/sum(df_sort$ans))/100,"%",sep=""),cex=0.7,
      y=seq(from=1,length.out=33,by=1.19),
      x=df_sort$ans+6)
...
col<-c(brewer.pal(9, "YlOrRd")[1:9],brewer.pal(9, "Blues")[1:9])
par(family="STKaiti")
barplot(df_sort$ans,family="STKaiti",horiz=TRUE,xlim=c(-100,250),col = col)
title(main=list("推广单元各模块消费比例",cex=2),sub="时间:2021.12.06-2021.12.12", ylab="推广单元",xlab="数量")
text(y=seq(from=1,length.out=33,by=1.19),x=-30,label=df_sort$levels.baidu_keywords.关键词.,family="STKaiti",cex=0.5)
legend("topright",legend=levels(baidu_keywords$关键词),cex = 0.5,col=rev(col),ncol=2,pch = 15)
text(labels= paste(round(10000*df_sort$ans/sum(df_sort$ans))/100,"%",sep=""),cex=0.7,
      y=seq(from=1,length.out=33,by=1.19),
...
col<-c(brewer.pal(9, "YlOrRd")[1:9],brewer.pal(9, "Blues")[1:9])
par(family="STKaiti")
barplot(df_sort$ans,family="STKaiti",horiz=TRUE,xlim=c(-2000,10000),col = col)
title(main=list("推广单元各模块展示比例",cex=2),sub="时间:2021.12.06-2021.12.12", ylab="日期",xlab="数量")
text(y=seq(from=1,length.out=33,by=1.19),x=-1000,label=df_sort$levels.baidu_time_keywords.日期.,family="STKaiti",cex=1)
...
par(family="STKaiti")
barplot(df_sort$ans,family="STKaiti",horiz=TRUE,xlim=c(-100,100),col = col)
title(main=list("推广单元各模块点击比例",cex=2),sub="时间:2021.12.06-2021.12.12", ylab="日期",xlab="数量")
text(y=seq(from=1,length.out=33,by=1.19),x=-50,label=df_sort$levels.baidu_time_keywords.日期.,family="STKaiti",cex=1)
#legend("topright",legend=levels(baidu_time_keywords$日期),cex = 0.5,col=rev(col),ncol=2,pch = 15)
text(labels= paste(round(10000*df_sort$ans/sum(df_sort$ans))/100,"%",sep=""),cex=0.7,
      y=seq(from=1,length.out=33,by=1.19),
      x=df_sort$ans+10)
...
title(main=list("推广单元各模块消费比例",cex=2),sub="时间:2021.12.06-2021.12.12", ylab="日期",xlab="数量")
text(y=seq(from=1,length.out=33,by=1.19),x=-50,label=df_sort$levels.baidu_time_keywords.日期.,family="STKaiti",cex=1)
#legend("topright",legend=levels(baidu_time_keywords$日期),cex = 0.5,col=rev(col),ncol=2,pch = 15)
text(labels= paste(round(10000*df_sort$ans/sum(df_sort$ans))/100,"%",sep=""),cex=0.7,
      y=seq(from=1,length.out=33,by=1.19),
